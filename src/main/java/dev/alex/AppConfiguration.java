    ...
    public ServletContextInitializer initializer()
    {
        return new ServletContextInitializer()
        {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "dev.alex");
                servletContext.setInitParameter("tapestry.development-modules", "dev.alex.services.DevelopmentModule");
